...
inline void GBAMemory::eepromWrite(uint8_t value) {
...
inline bool GBAMemory::eepromRead() {
...
inline bool GBAMemory::addressesEepromChip(uint32_t address) {
    uint8_t addressSection = address >> 24;
    switch(addressSection) {
        case 0x09:
...
inline void GBAMemory::resetSerialBuffer() {
    serialBuffer = 0;
    transmittedBits = 0;
}